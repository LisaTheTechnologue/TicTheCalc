...
{
    public partial class CalculatorStd : Form
    {
        string factor1 = "";
        string factor2 = "";
        string result;
        ...
        private void BtnDivRem_Click(object sender, EventArgs e)
        {
        ...
        {
            CalculatorScf calc1 = new CalculatorScf();
            calc1.Show();
            this.Hide();
        }
        private void standardToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show("You are currently in the Standard mode", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
            TxtBoxCalc.Text = "0.";
        }
